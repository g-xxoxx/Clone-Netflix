    ...
    return (
        <div className='hero-bg relative'>
            ...
            <header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
                ...
                <Link to={"/login"} className='text-white bg-red-600 py-1 px-2 rounded'>Sign Up</Link>
            </header>
            ...
            <div className='flex flex-col items-center justify-center text-center py-40 text-white max-w-6xl mx-auto'>
                ...
                <form className='flex flex-col md:flex-row gap-4 w-1/2' onSubmit={handleForSubmit}>
            ...
            <div className='py-10 bg-black text-white'>
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
                    ...
                    <div className='flex-1 relative'>
                        ...
                        <video className='absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-[50%] z-10'
                            playsInline
                            autoPlay={true}
                            muted
                            loop
                ...
                <div className='flex max-w-6xl mx-auto items-center justify-center md:flex-row flex-col-reverse px-4 md:px-2'>
                    ...
                    <div className='flex-1'>
                        <div className='relative'>
                            ...
                            bg-black w-2/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2
                            '>
                    ...
                    <div className='flex-1 md:text-left text-center'>
                        ...
                        <p className='text-lg md:text-xl'>
                            Save your favorites easily and awlways have something to watch
                        </p>
                    </div>
                </div>
            </div>
            ...
            {/*3rd section */}
            <div className='py-10 bg-black text-white'>
                <div className='flex items-center justify-center mx-auto md:flex-row flex-col max-w-6xl px-4 md:px-2'>
                    {/*left side */}
                    <div className='flex-1 text-center md:text-left'>
                        <h2 className='text-4xl md:text-5xl font-extrabold mb-4'>Watch everywhere</h2>
                        <p className='text-lg md:text-1'>
