...
const SearchPage = () => {
    ...
    const handleSearch = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.get(`/api/v1/search/${activeTab}/${searchTerms}`)
        ...
        <div className="bg-black min-h-screen text-white">
            ...
            <div className="container mx-auto px-4 py-8">
                <div className="flex justify-center gap-3 mb-4">
                    ...
                    <button className={`py-2 px-4 bg-red-600 ${activeTab === "tv" ? "bg-red-600" : "bg-gray-800"}
                    hover:bg-red-700`}
                    ...
                    <button className={`py-2 px-4 bg-red-600 ${activeTab === "person" ? "bg-red-600" : "bg-gray-800"}
                    hover:bg-red-700`}
                ...
                <form className="flex gap-2 items-stretch mb-8 max-w-2xl mx-auto" onSubmit={handleSearch}>
                    ...
                    />
                    <button className="bg-red-800 hover:bg-red-700 text-white p-2 rounded">
                        <Search className='size-6' />
                    </button>
                </form>

                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap4">
                    {results.map((result) => {
